...
public class CreateOrder_Buyer extends UseCase<Order_Buyer, CreateOrder_Buyer.Params> {
    ...
    @Override
    protected Observable<Order_Buyer> buildUseCaseObservable(Params params) {
    ...
    public static final class Params {
        ...
        public static Params forCreateOrder(String token, Order_Buyer order) {
            return new Params(token, order);
        }
    }
}
