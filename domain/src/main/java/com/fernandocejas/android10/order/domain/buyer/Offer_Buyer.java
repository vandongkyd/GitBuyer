...
public class Offer_Buyer implements Serializable {
    ...
    private Rate_Buyer rate;
    private Address_Buyer address;
    ...
    public Rate_Buyer getRate() {
        return rate;
    }

    public void setRate(Rate_Buyer rate) {
        this.rate = rate;
    }

    public Address_Buyer getAddress() {
        return address;
    }

    public void setAddress(Address_Buyer address) {
