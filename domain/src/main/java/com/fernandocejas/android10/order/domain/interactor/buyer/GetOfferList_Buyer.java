...
public class GetOfferList_Buyer extends UseCase<List<Order_Buyer>, GetOfferList_Buyer.Params> {

    private final OrderRepository_Buyer orderRepository_buyer;

    @Inject
    GetOfferList_Buyer(OrderRepository_Buyer orderRepository_buyer, ThreadExecutor threadExecutor,
    ...
    @Override
    protected Observable<List<Order_Buyer>> buildUseCaseObservable(Params params) {
        Preconditions.checkNotNull(params);
        return this.orderRepository_buyer.myoffer_buyer(params.access_token);
    }
    ...
    public static final class Params {
        ...
        public static Params forOffer(String access_token) {
            return new Params(access_token);
        }
    }
}
