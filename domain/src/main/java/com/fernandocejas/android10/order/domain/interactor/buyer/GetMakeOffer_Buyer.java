...
public class GetMakeOffer_Buyer extends UseCase<Offer_Buyer, GetMakeOffer_Buyer.Params> {
    ...
    @Override
    protected Observable<Offer_Buyer> buildUseCaseObservable(Params params) {
    ...
    public static final class Params {
        ...
        public static Params forMake(String access_token,
                                     String orderid,
                                     String deviverdate,
                                     String providerfee,
                                     String shipfee,
                                     ...
                                     String otherfee,
                                     String description) {
            return new Params(access_token, orderid, deviverdate, providerfee, shipfee, surchargefee, otherfee, description);
        }
    }
}
