...
import com.fernandocejas.android10.order.domain.interactor.buyer.RegisterUser_Buyer;
...
public class VerifyPhonePresenter implements Presenter, Validator.ValidationListener {
    ...
    @Inject
    public VerifyPhonePresenter(RegisterUser_Buyer registerUserUseCase) {
    ...
    private void signUp(String name,
                        ...
                        String password,
                        String phone_code) {
        this.registerUserUseCase.execute(new SignUpObserver(), RegisterUser_Buyer.Params.forUserRegister(
                name,
                email,
                password,
                phone,
