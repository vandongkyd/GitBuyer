...
import com.fernandocejas.android10.order.presentation.view.buyer.SlideshowAdapterView_Buyer;
...
public class SlideshowAdapter_Buyer extends PagerAdapter implements SlideshowAdapterView_Buyer {

    private Context context;

    private LayoutInflater inflater;

    private ArrayList<ImageModel_Buyer> mList;

    @Inject
    public SlideshowAdapter_Buyer(Context context) {
        this.context = context;
        mList = new ArrayList<>();
    }

    public void replaceWith(Collection<ImageModel_Buyer> newValues) {
        mList.clear();
        if (newValues != null) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ImageModel_Buyer imageModel = mList.get(position);
    ...
    @Override
    public void showImageInView(SlideshowAdapter_Buyer.ViewHolder viewHolder, String url) {
