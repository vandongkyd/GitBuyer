...
/**
 * Created by vandongluong on 3/26/18.
 */

public class TestAcitivity extends BaseActivity implements HasComponent<OrderComponent> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            OfferMakeFragment_Buyer settingFragment = new OfferMakeFragment_Buyer();
