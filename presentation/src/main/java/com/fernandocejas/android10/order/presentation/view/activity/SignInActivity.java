...
public class SignInActivity extends BaseActivity implements HasComponent<OrderComponent> {
    ...
    /**
     * Goes to the home buyer screen.
     */
    public void navigateToHome_Buyer() {
        this.navigator.navigateToHome_Buyer(this);
        finish();
    }

    /**
     * Goes to the company buyer screen.
     */
    public void navigateToCompany_Buyer() {
       /* this.navigator.navigateToCompany_Buyer(this);
        finish();*/
        CompanyFragment_Buyer companyFragment_buyer = new CompanyFragment_Buyer();
        addFragment(R.id.fragmentContainer, companyFragment_buyer, true);
    }
}
