...
public class Navigator {
    ...
    /**
     * Goes to home_buyer screen.
     *
     * @param context A Context needed to open the destiny activity.
     */
    public void navigateToHome_Buyer(Context context) {
        if (context != null) {
            Intent intentToLaunch = HomeActivity_Buyer.getCallingIntent(context);
            context.startActivity(intentToLaunch);
        }
    }
     ...
     * @param context A Context needed to open the destiny activity.
     */
    public void navigateToOrderDetail_Buyer(Context context, Order_Buyer order_buyer, int type) {
        if (context != null) {
            Intent intentToLaunch = OrderDetailActivity_Buyer.getCallingIntent(context, order_buyer, type);
            context.startActivity(intentToLaunch);
        }
    }

    /**
     * Goes to the order company screen.
     *
     * @param context A Context needed to open the destiny activity.
     */
    public void navigateToCompany_Buyer(Context context) {
        if (context != null) {
            Intent intentToLaunch = CompanyActivity_Buyer.getCallingIntent(context);
            context.startActivity(intentToLaunch);
        }
    }
     ...
     * @param context A Context needed to open the destiny activity.
     */
    public void navigateToMakeOffer_Buyer(Context context, Order_Buyer order_buyer) {
        if (context != null) {
            Intent intentToLaunch = OfferMakeActivity_Buyer.getCallingIntent(context, order_buyer);
            context.startActivity(intentToLaunch);
        }
    }

//    public void navigateToMakeOffer_Buyer(Context context) {
//        if (context != null) {
//            Intent intentToLaunch = OfferMakeActivity_Buyer.getCallingIntent(context);
//            context.startActivity(intentToLaunch);
//        }
//    }
