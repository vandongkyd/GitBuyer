...
import com.fernandocejas.android10.restrofit.enity.buyer.OfferEntity_Buyer;
...
public class OfferEntityDataMapper_Buyer {
    ...
    private final AddressEntityDataMapper_Buyer addressEntityDataMapper;
    private final RateEntityDataMapper_Buyer rateEntityDataMapper;
    private final ShipInfoEntityDataMapper shipInfoEntityDataMapper;

    @Inject
    OfferEntityDataMapper_Buyer(AddressEntityDataMapper_Buyer addressEntityDataMapper,
                                RateEntityDataMapper_Buyer rateEntityDataMapper, ShipInfoEntityDataMapper shipInfoEntityDataMapper) {
    ...
    public Offer_Buyer transform(OfferEntity_Buyer offerEntity_buyer) {
        ...
        if (offerEntity_buyer != null) {
            ...
            offer_buyer.setAddress(addressEntityDataMapper.transform(offerEntity_buyer.getAddress()));
            if (offerEntity_buyer.getShip_from_country() != null){
                offer_buyer.setShip_from_country(shipInfoEntityDataMapper.transform(offerEntity_buyer.getShip_from_country()));
            }
        }
        return offer_buyer;
    }
    ...
    public OfferEntity_Buyer transform(final Offer_Buyer offer_buyer) {
        ...
        if (offer_buyer != null) {
            ...
            offerEntity_buyer.setAddress(addressEntityDataMapper.transform(offer_buyer.getAddress()));
            if (offer_buyer.getShip_from_country()!= null){
                offerEntity_buyer.setShip_from_country(shipInfoEntityDataMapper.transform(offer_buyer.getShip_from_country()));
            }
        }
