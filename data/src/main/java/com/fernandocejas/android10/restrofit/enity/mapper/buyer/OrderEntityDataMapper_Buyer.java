...
import com.fernandocejas.android10.restrofit.enity.buyer.OrderEnity_Buyer;
import com.fernandocejas.android10.restrofit.enity.buyer.OrderEntityResponse_Buyer;
...
public class OrderEntityDataMapper_Buyer {
    ...
    private final ShipInfoEntityDataMapper shipInfoEntityDataMapper;
    ...
    OrderEntityDataMapper_Buyer(AddressEntityDataMapper_Buyer addressEntityDataMapper_buyer,
                                ...
                                ShipInfoEntityDataMapper shipInfoEntityDataMapper) {
        ...
        this.shipInfoEntityDataMapper = shipInfoEntityDataMapper;
    }
    ...
    public Order_Buyer transform(OrderEnity_Buyer orderEntity_buyer) {
        ...
        if (orderEntity_buyer != null) {
            ...
            if (orderEntity_buyer.getDeliverto() != null) {
                order_buyer.setDeliverto(addressEntityDataMapper_buyer.transform(orderEntity_buyer.getDeliverto()));
            }
            ...
            order_buyer.setOfferid(orderEntity_buyer.getOfferid());
            order_buyer.setOffer_description(orderEntity_buyer.getOffer_description());
            order_buyer.setProviderfee(orderEntity_buyer.getProviderfee());
            order_buyer.setShipfee(orderEntity_buyer.getShipfee());
            order_buyer.setSurchargefee(orderEntity_buyer.getSurchargefee());
            order_buyer.setOtherfee(orderEntity_buyer.getOtherfee());
            //order_buyer.setShip_from_country(orderEntity_buyer.getShip_from_country());
            if (orderEntity_buyer.getShip_from_country() != null) {
                order_buyer.setShip_from_country(shipInfoEntityDataMapper.transform(orderEntity_buyer.getShip_from_country()));
            }
            ...
            if(orderEntity_buyer.getOrder_info()!= null){
                order_buyer.setOrder_info(userEntityDataMapper_buyer.transform(orderEntity_buyer.getOrder_info()));
            }
        }
        return order_buyer;
    }
    ...
    public OrderEnity_Buyer transform(Order_Buyer order_buyer) {
        ...
        if (order_buyer != null) {
            ...
            orderEnity_buyer.setDeliverto(addressEntityDataMapper_buyer.transform(order_buyer.getDeliverto()));
            ...
            orderEnity_buyer.setShip_from_country(shipInfoEntityDataMapper.transform(order_buyer.getShip_from_country()));
